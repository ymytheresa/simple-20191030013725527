package com.bochk.hackathon.api.functional;
...
import com.bochk.hackathon.api.functional.auth.ApiKeyAuth;
import com.bochk.hackathon.api.functional.auth.OAuth;
import com.bochk.hackathon.api.functional.auth.OAuth.AccessTokenListener;
import com.bochk.hackathon.api.functional.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      Interceptor auth;
      if ("Basic authentication".equals(authName)) {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://bocapis.mybluemix.net/api";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
