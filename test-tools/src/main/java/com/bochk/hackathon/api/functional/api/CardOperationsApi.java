...
import com.bochk.hackathon.api.functional.model.CreditCard;
import com.bochk.hackathon.api.functional.model.CreditCardPaymentRequest;
import com.bochk.hackathon.api.functional.model.CreditCardPaymentResponse;
import com.bochk.hackathon.api.functional.model.CreditCardTransaction;
...
public interface CardOperationsApi {
  ...
  Call<CreditCardPaymentResponse> creditCardsCardNoPaymentPost(
    @retrofit2.http.Path("card_no") String cardNo, @retrofit2.http.Header("ibm-app-user") String ibmAppUser, @retrofit2.http.Body CreditCardPaymentRequest body
  );
  ...
  Call<List<CreditCardTransaction>> creditCardsCardNoTransactionsGet(
    @retrofit2.http.Path("card_no") String cardNo, @retrofit2.http.Header("ibm-app-user") String ibmAppUser
  );
