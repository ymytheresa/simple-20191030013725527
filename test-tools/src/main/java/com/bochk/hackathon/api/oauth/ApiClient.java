package com.bochk.hackathon.api.oauth;
...
import com.bochk.hackathon.api.oauth.auth.HttpBasicAuth;
import com.bochk.hackathon.api.oauth.auth.ApiKeyAuth;
import com.bochk.hackathon.api.oauth.auth.OAuth;
import com.bochk.hackathon.api.oauth.auth.OAuth.AccessTokenListener;
import com.bochk.hackathon.api.oauth.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      Interceptor auth;
      if ("OAuth2 Authorization Code Grant".equals(authName)) {
        auth = new OAuth(OAuthFlow.accessCode, "https://api.au.apiconnect.ibmcloud.com/hkboc-hackathon/dev/oauth2/authorize", "https://api.au.apiconnect.ibmcloud.com/hkboc-hackathon/dev/oauth2/token", "all");
      } else if ("OAuth2 Client Credentials Grant".equals(authName)) {
        auth = new OAuth(OAuthFlow.application, "", "https://api.au.apiconnect.ibmcloud.com/hkboc-hackathon/dev/oauth2/token", "all");
      } else {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://api.au.apiconnect.ibmcloud.com/hkboc-hackathon/dev/api";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
